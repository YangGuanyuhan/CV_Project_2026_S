...
# Mapping from COCO category_id (1-80) to category name
CATEGORY_ID_TO_NAME: dict[int, str] = {i + 1: name for i, name in enumerate(COCO_80_CLASSES)}

# Mapping from category name to COCO category_id (1-80)
CATEGORY_NAME_TO_ID: dict[str, int] = {name: i + 1 for i, name in enumerate(COCO_80_CLASSES)}
